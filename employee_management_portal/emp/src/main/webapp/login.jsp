    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-3 card" style="background-color: lemonchiffon">
                <div class="card-body">
                    <h4 class="text-center border-bottom" style="color: indigo">Login Form</h4>
                    <br>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        <label style="">Emp ID</label> <input class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 pr-0">
                                                ...
                                                <input class="form-control " type="password"
                                                    name="password" placeholder="Enter Password" id="password" /><span class="input-group-btn">
                                            </div>
                                        </div>
